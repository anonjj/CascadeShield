...
docs/paper/decision-log.md D16.)
...
outcomes decide between decision D16's options:
  ...
  - MACHINE_EFFECT_DETECTED   -> fall back to (b): no cross-topology time_to_open /
    ...
    blast-radius-style ratios (D15) are NOT gated by this -- they are assumed
...
def machine_effect(df):
    ...
    if undefined_dvs:
        # D16's gate covers time_to_open and time_to_recover as one blanket rule, not
