...
def load_transition_index(path):
    ...
    D-008's calibration protocol runs the identical experiment_id/replicate/mode/
...
def self_test():
    ...
    # 8. Two machines colliding on every OTHER key (D-008's calibration protocol runs
