...
> machines.** The triple was scoped before D6/D16 added `machine_id`, back when
...
> calibration block (D16) deliberately runs the *same* `(experiment_id, environment,
