...
each landing page (T2, 2026-09-21), lives in [`references.bib`](references.bib)** — including
broader microservice-resilience/circuit-breaker context citations beyond this file's own
near-miss table, and the fix for one author-order error this pass caught (the "Zdun et al."
row below; verified order is El Malki, Zdun, Pautasso).
