...
def main():
    ...
    parser.add_argument("--mode", choices=["canary", "full", "sweep"], default="canary", help="canary (5 configs × 3 replicates = 15 runs), full (54 configs × 3 replicates = 162 runs per fault type; 324 total across 2 faults), or sweep (crash toxicity sweep -- writes to data/crash_toxicity_sweep.csv, not master; use with --fault crash --toxicity)")
